...
Blockly.Lua['colour_rgb'] = function(block) {
  ...
  var red = Blockly.Lua.valueToCode(block, 'RED',
      Blockly.Lua.ORDER_COMMA) || 0;
  var green = Blockly.Lua.valueToCode(block, 'GREEN',
      Blockly.Lua.ORDER_COMMA) || 0;
  var blue = Blockly.Lua.valueToCode(block, 'BLUE',
      Blockly.Lua.ORDER_COMMA) || 0;
  var functionName = Blockly.Lua.provideFunction_(
      'colour_rgb',
      [ 'function ' + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Lua['colour_blend'] = function(block) {
  ...
  var c1 = Blockly.Lua.valueToCode(block, 'COLOUR1',
      Blockly.Lua.ORDER_COMMA) || '\'#000000\'';
  var c2 = Blockly.Lua.valueToCode(block, 'COLOUR2',
      Blockly.Lua.ORDER_COMMA) || '\'#000000\'';
  var ratio = Blockly.Lua.valueToCode(block, 'RATIO',
      Blockly.Lua.ORDER_COMMA) || 0.5;
  var functionName = Blockly.Lua.provideFunction_(
      'colour_blend',
      [ 'function ' + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
          '(c1, c2, ratio) {',
